...
export interface CopyServiceIf {
     ...
     */
    copyToClipboard(tableModel: TableModelIf, selectionModel: SelectionModelIf | undefined, focusModel: FocusModelIf | undefined): Promise<string>;
    /**
     ...
     */
    createContent(tableModel: TableModelIf, selectionModel: SelectionModelIf | undefined, focusModel: FocusModelIf | undefined): Promise<string>;
    /**
