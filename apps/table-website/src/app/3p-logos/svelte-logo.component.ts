...
@Component({
  selector: "app-svelte-logo",
  template: `
    <!-- SVELTE-->
    <svg id="Layer_1" style="enable-background:new 0 0 98.1 118;" version="1.1"
      ...
      <path class="logo-fill-color-1" d="M40.9,103.9c-8.9,2.3-18.2-1.2-23.4-8.7c-3.2-4.4-4.4-9.9-3.5-15.3c0.2-0.9,0.4-1.7,0.6-2.6l0.5-1.6l1.4,1
...
export class SvelteLogoComponent {
}
