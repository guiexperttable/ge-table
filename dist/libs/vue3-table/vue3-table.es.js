import { defineComponent as G, ref as N, onMounted as z, openBlock as j, createElementBlock as X, createVNode as K, render as k } from "vue";
class B {
  constructor(e = -1, t = -1, s = -1, i = -1, o, r, l, n = 0, a = 0, d = 0, S = "") {
    this.rowIndex = e, this.rowTop = t, this.columnIndex = s, this.columnLeft = i, this.areaIdent = o, this.sideIdent = r, this.originalEvent = l, this.clickCount = n, this.draggingX = a, this.draggingY = d, this.action = S;
  }
  clone() {
    return new B(
      this.rowIndex,
...
class Y {
  ...
  addRowDiv(e, t, s = -1, i, o, r = "") {
    ...
    if (this.domService.addClass(n, "ge-table-row-div"), this.domService.addClass(n, `ge-table-row-div-${t.index}`), i === "body" && o === "center") {
  ...
  addColumnDiv(e, t, s = -1, i = -1, o, r, l = "", n, a, d = void 0, S) {
    ...
    if (o === "body" && r === "center" && this.domService.addClass(c, `ge-table-column-${b}`), this.domService.setStyle(c, "display", "clip"), this.domService.setStyle(c, "position", "absolute"), this.domService.setStyle(c, "left", `${t.left}px`), this.domService.setStyle(c, "top", `${t.top}px`), this.domService.setStyle(c, "width", `${t.width}px`), this.domService.setStyle(c, "height", `${t.height}px`), n && n !== "none" && (this.domService.addClass(c, "ge-table-col-tree"), this.addArrowDiv(c, n, g, s, i, o)), f && i === 0 && d && this.addCheckboxToDiv(c, d, o, s), l) {
      const p = n !== "none" && i === 0;
      this.addLabelDiv(c, l, p, s, i, o);
    }
    return S && this.addSortedIcon(c, S, a == null ? void 0 : a.sortedOptions, i), this.domService.appendChild(e, c), c;
  }
  ...
  addLabelDiv(e, t = "", s = !1, i = -1, o = -1, r = "body") {
    ...
    if (this.domService.addClass(l, "ge-table-label-div"), this.domService.setStyle(l, "position", "relative"), this.domService.setStyle(l, "background", "transparent"), this.domService.setStyle(l, "width", "100%"), this.domService.setStyle(l, "height", "100%"), this.domService.setAttribute(l, "data-row-index", `${i}`), this.domService.setAttribute(l, "data-col-index", `${o}`), this.domService.setAttribute(l, "data-area", `${r}`), t)
      if (s) {
        ...
        this.domService.addClass(n, "ge-table-label"), this.domService.appendChild(n, a), this.domService.setAttribute(n, "data-row-index", `${i}`), this.domService.setAttribute(n, "data-col-index", `${o}`), this.domService.setAttribute(n, "data-area", `${r}`);
      }
    return this.domService.appendChild(e, l), l;
  }
  addSortedIcon(e, t = "", s = new W(), i = -1) {
    const o = this.domService.createElement("div");
...
const $ = (h) => h === "header" ? "header" : h === "footer" ? "footer" : "body";
class q {
  constructor(e, t) {
...
class U {
  ...
  onHostElementClicked(e) {
    ...
    else if (t.row instanceof O && t.areaModel) {
  ...
  onHostElementDblClicked(e) {
    if (e.target instanceof HTMLElement) {
      ...
      if (s && i === "header")
        ...
        if (s && i === "body" && l.isEditable(o, r) && (this.tableScope.clearSelection(), this.tableScope.initRenderEditor(o, r)), n instanceof O && r === this.getArrowColumnIndex()) {
          e.preventDefault(), e.stopPropagation();
          const a = n;
  ...
  updateCollapsedExpandedState(e) {
    ...
    if (t) {
      const n = (o = this.tableScope.storeStateCollapsedExpandService) == null ? void 0 : o.collapsedExpandedStateGet().mode, a = n === "collapsed" && !e.expanded || n === "expanded" && e.expanded, d = n === "collapsed" && e.expanded || n === "expanded" && !e.expanded, S = t(e.data);
      a ? (r = this.tableScope.storeStateCollapsedExpandService) == null || r.collapsedStateIdsPush(S) : d && ((l = this.tableScope.storeStateCollapsedExpandService) == null || l.collapsedStateIdsRemove(S));
    }
  }
  getArrowColumnIndex() {
...
class L extends Z {
  constructor(e, t, s, i = []) {
    super(e, i, s), this.areaIdent = e, this.rows = t, this.defaultRowHeight = s, this.columnDefs = i, this.sorterService = new ee(), this.service = new Q(), this.properties = i.map((o) => o.property), this.flattenRows = this.service.flattenTree(t), this.filteredFlattenRows = [...this.flattenRows];
  }
  changeColumnOrder(e, t) {
  ...
  setValue(e, t, s) {
    ...
    if (o) {
      const l = o.data, n = this.columnDefs[t].property;
      return n.includes(".") ? this.setPropertyValue(l, n.split("."), s) : (l[n] = s, !0);
    }
    return !1;
  }
...
class ie extends P {
  constructor(e) {
    super(e), this.COLLAPSED_EXPANDED_STATE = "collapsedExpandedState", this.collapsedExpandedState = new se(), this.load();
  }
...
class ae extends re {
  ...
  adjustArea(e, t = 0) {
    ...
    const l = 0, n = this.areaBodyCenterGeo.width, a = this.tableModel.getPadding(), d = this.tableModel.getAreaModel(e), S = d.getRowCount();
    ...
    for (let u = 0; u < S; u++) {
      ...
      if (v + C > 0) {
        ...
        let w = { left: l, width: n, height: C, top: v, index: u }, m = this.dom.addRowDiv(i, w, u, e, "center");
        const M = b;
        if (this.adjustColumnsToRowParent({
          ...
          verticalFixed: !1,
          lastRowOfModel: x
        }), a.left > 0 && (w = { left: l, width: this.areaBodyWestGeo.width, height: C, top: v, index: u }, m = this.dom.addRowDiv(s, w, u, e, "west"), this.adjustColumnsToRowParent({
          areaIdent: e,
          sideIdent: "west",
          areaModel: d,
          geo: w,
          ...
          verticalFixed: !0,
          lastRowOfModel: x
        })), a.right > 0 && (w = { left: l, width: this.areaBodyEastGeo.width, height: C, top: v, index: u }, m = this.dom.addRowDiv(o, w, u, e, "east"), this.adjustColumnsToRowParent({
          areaIdent: e,
          sideIdent: "east",
          areaModel: d,
          geo: w,
    ...
    if (this.colAndRowspanModels && this.colAndRowspanModels[e]) {
      const u = ((p = this.colAndRowspanModels[e]) == null ? void 0 : p.getRanges()) ?? [];
      if (u.length)
        for (const v of u) {
  ...
  drawBigCell(e, t, s, i, o, r) {
    const l = s + this.getRowHeights(0, e.r1 - 1, i).reduce((p, u) => p + u, 0), n = this.tableModel.getColumnCount(), a = this.tableModel.getFixedRightColumnCount();
    let d = 0;
    a > 0 && e.c1 >= n - a && (d = n - a);
    const S = t + this.getColumnWidths(d, e.c1 - 1).reduce((p, u) => p + u, 0), g = this.getRowHeights(e.r1, e.r2, i).reduce((p, u) => p + u, 0), f = this.getColumnWidths(e.c1, e.c2).reduce((p, u) => p + u, 0);
    let c = !1;
  ...
  adjustColumnsToRowParent({
    ...
    if (!a) {
      ...
      S = this.scrollFactorX * p;
    }
    const g = 0, f = !!(e === "body" && t);
    let c = S;
    for (let p = l; p <= n; p++) {
      const u = c, v = this.tableModel.getColumnWidth(p);
      if (v > 0 && u + v > 0) {
        let x = i.height;
        const C = s.getRowspanAt(r, p), w = s.getColspanAt(r, p);
        C > 1 && (x = this.getRowHeights(r, r + C - 1, s).reduce((E, R) => E + R, 0));
        let m = v;
        w > 1 && (m = this.getColumnWidths(p, p + w - 1).reduce((E, R) => E + R, 0));
        let M = !1;
        if (this.colAndRowspanModels && this.colAndRowspanModels[e] && (b = this.colAndRowspanModels[e]) != null && b.isInRange(r, p) && (M = !0), this.draggingTargetColumnIndex === p && e !== "header") {
          ...
          const E = this.renderSelectedBackgroundDiv(M, f, t, s, r, p, o, u, g, m, x);
          M || this.renderCell({
            areaModel: s,
            areaIdent: e,
            sideIdent: t,
  ...
  addAndRenderCellDiv({
    ...
    var _;
    const f = this.editorRenderer && this.editorRendererRow === i && this.editorRendererColumn === o ? this.editorRenderer : e.getCellRenderer(i, o), c = { left: r, width: l, height: n, top: a, index: o }, b = e.getRowByIndex(i);
    let p = "none";
    if (o === this.getTreeArrowColumnIndex() && b instanceof O) {
      const y = b;
      (_ = y.children) != null && _.length ? y.expanded ? p = "expanded" : p = "collapsed" : p = "hidden";
    }
    let v;
    if (t === "header") {
    ...
    let R;
    f && (R = f.render(m, i, o, t, e, x, this.dom.domService));
    const D = e.getCustomClassesAt(i, o);
    if (D.length && this.dom.addClasses(D, m), this.dom.addColumnBorderDivs(this.tableOptions, d, c, t, s), S && this.dom.addHorizontalBorder({ left: r, width: l, height: n, top: a + n }, d), this.getFocusModel && t === "body") {
  ...
  renderSelectedBackgroundDiv(e, t, s, i, o, r, l, n, a, d, S) {
    let g = !1;
    if (!e && t && i.isSelectable(o, r) && this.getSelectionModel) {
      ...
      if (f) {
        ...
        g = c > 0;
        for (let b = 0; b < c; b++) {
          const p = this.dom.applyStylePosistionAbsolute(
            // ge-table-body-west-selected-range
            this.dom.createDivWithClass(`ge-table-${i.areaIdent}-${s}-selected-range`, l)
          );
          this.dom.setStyle(p, "left", `${n}px`), this.dom.setStyle(p, "top", `${a}px`), this.dom.setStyle(p, "width", `${d}px`), this.dom.setStyle(p, "height", `${S}px`);
        }
      }
    }
    return g;
  ...
  renderCell({
    ...
    S && this.dom.addClass(`ge-table-${t}-${s}-selected-range`, c), b && this.cleanupFunctions[t].push(b);
  }
...
class he {
  ...
  onHostElementChanged(e) {
    if (e.target instanceof HTMLInputElement || e.target instanceof HTMLSelectElement || e.target instanceof HTMLTextAreaElement) {
      ...
      if (s && i && o) {
        const r = $(s), l = Number(i), n = Number(o);
...
class me extends ae {
  constructor(e, t, s, i, o) {
    ...
    if (super(
      ...
      n && (l.autoRestoreScrollPosition && (this.storeScrollPosStateService = new te(n)), l.autoRestoreCollapsedExpandedState && (this.storeStateCollapsedExpandService = new ie(n)), l.autoRestoreSortingState && (this.storeSortingService = new oe(n)));
    }
  ...
  toggleExpandCollapseAll(e = !0) {
    ...
    t instanceof L && (t.toggleExpandCollapseAll(e), this.repaint(), (s = this.storeStateCollapsedExpandService) == null || s.collapsedStateAll(e));
  }
  ...
  onHeaderDblClicked(e, t, s) {
    ...
    if (i != null && i.sortable && i.sortable()) {
      e.preventDefault(), e.stopPropagation();
      const l = i.sortStatesOrder ? i.sortStatesOrder : this.tableOptions.sortOrder, n = i.sortState ?? "", a = l[(l.indexOf(n) + 1) % l.length], d = new de(s, a);
...
class Ce {
  constructor() {
    this.overflowX = "auto", this.overflowY = "auto", this.horizontalBorderVisible = !0, this.verticalBorderVisible = !0, this.footerSeparatorBorderVisible = !0, this.headerSeparatorBorderVisible = !0, this.fixedEastSeparatorBorderVisible = !0, this.fixedWestSeparatorBorderVisible = !0, this.tableTopBorderVisible = !0, this.tableBottomBorderVisible = !0, this.hoverRowVisible = !0, this.hoverColumnVisible = !0, this.columnsResizable = !0, this.columnsDraggable = !0, this.columnResizeHandleWidthInPx = 4, this.defaultRowHeights = {
      ...
      body: 34,
      footer: 34
    }, this.footerVerticalSeparator = !1, this.headerToggleExpandCollapseIcons = !1, this.headerVerticalSeparator = !1, this.treeOptions = new H(), this.showCheckboxWihoutExtraColumn = !1, this.externalFilterFunction = void 0, this.sortedOptions = new W(), this.sortOrder = ["asc", "desc"], this.getEditRenderer = (e, t) => new be(), this.getSelectionModel = () => ve, this.getFocusModel = () => xe;
  }
}
class Ee {
  setStyle(e, t, s) {
  ...
  setup(h, { emit: e }) {
    const t = N(null), s = (i) => {
      const o = {
        ...
        onMouseDraggingEnd: (l) => {
          e("mouseDraggingEnd", l);
        },
        onMouseMoved: (l) => {
          e("mouseMoved", l);
        }
      ...
      r.firstInit(), e("tableReady", r.getApi());
    };
    return z(() => {
      t.value && s(t.value);
    }), {
...
function Te(h, e, t, s, i, o) {
  return j(), X("div", Me, null, 512);
}
const De = /* @__PURE__ */ Re(Ae, [["render", Te]]);
class Fe {
  constructor(e, t) {
    this.component = e, this.appContext = t;
  }
  render(e, t, s, i, o, r, l) {
    return this.mount(
      this.component,
  ...
  mount(e, t, s, i) {
    let o = K(e, t);
    return o.appContext = s, k(o, i), () => {
      i && k(null, i);
    };
  }
}
export {
  Fe as ComponentRendererWrapper,
  De as GuiexpertTable
};
