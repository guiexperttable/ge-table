class B {
  constructor(e = -1, t = -1, s = -1, i = -1, o, l, n, r = 0, a = 0, d = 0, S = "") {
    this.rowIndex = e, this.rowTop = t, this.columnIndex = s, this.columnLeft = i, this.areaIdent = o, this.sideIdent = l, this.originalEvent = n, this.clickCount = r, this.draggingX = a, this.draggingY = d, this.action = S;
  }
  clone() {
    return new B(
      this.rowIndex,
...
class _ {
  ...
  addRowDiv(e, t, s = -1, i, o, l = "") {
    const n = t.index ?? -1, r = this.getDivOrCreateDiv(n, e);
    if (this.domService.addClass(r, "ge-table-row-div"), this.domService.addClass(r, `ge-table-row-div-${t.index}`), i === "body" && o === "center") {
      const a = ((t == null ? void 0 : t.index) ?? 0) % 2 === 0 ? "even" : "odd";
      this.domService.addClass(r, `ge-table-row-${a}`);
    }
    if (this.domService.setStyle(r, "display", "clip"), this.domService.setStyle(r, "position", "absolute"), this.domService.setStyle(r, "left", `${t.left}px`), this.domService.setStyle(r, "top", `${t.top}px`), this.domService.setStyle(r, "width", `${t.width}px`), this.domService.setStyle(r, "height", `${t.height}px`), this.domService.setAttribute(r, "data-row-index", `${s}`), this.domService.setAttribute(r, "data-area", `${i}`), l) {
      const a = this.domService.createText(l);
      this.domService.appendChild(r, a);
    }
    return this.domService.appendChild(e.child, r), r;
  }
  addColumnDiv(e, t, s = -1, i = -1, o, l, n = "", r, a, d = void 0, S) {
    const g = a == null ? void 0 : a.treeOptions, f = a == null ? void 0 : a.showCheckboxWihoutExtraColumn, h = this.domService.createElement("div");
  ...
  addCheckboxToDiv(e, t, s, i) {
    const o = this.domService.createElement("div"), l = t === "full" ? "checked" : "";
    return o.innerHTML = `
            <input
                type="checkbox"
                data-area="${s}"
  ...
  addSortedIcon(e, t = "", s = new V(), i = -1) {
    ...
    let l;
    t === "asc" ? l = s.iconAsc : t === "desc" ? l = s.iconDesc : l = s.iconPlaceholder;
    const n = l.content, r = this.domService.createText(n);
    this.domService.appendChild(o, r), l.style && this.applyStyleString(o, l.style);
    for (const a of l.classes)
      this.domService.addClass(o, a);
    return this.domService.appendChild(e, o), o;
  }
  addArrowDiv(e, t = "none", s = new W(), i = -1, o = -1, l = "body") {
    const n = this.domService.createElement("div");
    this.domService.addClass(n, "ge-table-tree-arrow-div"), this.domService.setStyle(n, "display", "inline-block"), this.domService.setStyle(n, "position", ""), this.domService.setStyle(n, "width", "20px"), this.domService.setStyle(n, "background", "transparent"), this.domService.setStyle(n, "cursor", "pointer"), this.domService.setAttribute(n, "data-row-index", `${i}`), this.domService.setAttribute(n, "data-col-index", `${o}`), this.domService.setAttribute(n, "data-area", `${l}`);
    let r;
    t === "expanded" ? r = s.arrowExpanded : t === "collapsed" ? r = s.arrowCollapsed : r = s.arrowPlaceholder;
    const a = r.content, d = this.domService.createText(a);
    this.domService.appendChild(n, d), r.style && this.applyStyleString(n, r.style);
  ...
  addColumnBorderDivs(e, t, s, i, o) {
    if (e.verticalBorderVisible) {
      const l = `ge-table-${i}-${o}-vertical-border`;
      this.addVerticalBorder(s, t, l);
    }
    if (e.horizontalBorderVisible) {
      const l = `ge-table-${i}-${o}-horizontal-border`;
      this.addHorizontalBorder(s, t, l);
    }
    return t;
  }
  ...
  applyStyleString(e, t) {
    ...
    for (const i of s) {
      const [o, l] = i.split(":");
      this.domService.setStyle(e, o.trim(), l.trim());
    }
  }
...
class L {
  constructor(e, t = !0, s, i, o = 0, l = !1, n = !1) {
    this.data = e, this.expanded = t, this.children = s, this.parent = i, this.deep = o, this.checked = l, this.keep = n;
  }
}
const P = (u) => u === "header" ? "header" : u === "footer" ? "footer" : "body";
class G {
  constructor(e, t) {
...
class N {
  ...
  onHostElementClicked(e) {
    const t = new G(e.target, this.tableScope);
  ...
  onHostElementDblClicked(e) {
    if (e.target instanceof HTMLElement) {
      const t = e.target, s = t.getAttribute("data-area"), i = P(s), o = Number(t.getAttribute("data-row-index")), l = Number(t.getAttribute("data-col-index")), n = this.tableScope.tableModel.getAreaModel(i);
      if (s && i === "header")
        this.tableScope.tableModel.isSortable(l) && (this.tableScope.clearSelection(), this.tableScope.onHeaderDblClicked(e, o, l));
      else if (t.getAttribute("data-row-index")) {
        const r = n.getRowByIndex(o);
        if (s && i === "body" && n.isEditable(o, l) && (this.tableScope.clearSelection(), this.tableScope.initRenderEditor(o, l)), r instanceof L && l === this.getArrowColumnIndex()) {
          e.preventDefault(), e.stopPropagation();
          const a = r;
  ...
  updateCollapsedExpandedState(e) {
    ...
    if (t) {
      const r = (o = this.tableScope.storeStateCollapsedExpandService) == null ? void 0 : o.collapsedExpandedStateGet().mode, a = r === "collapsed" && !e.expanded || r === "expanded" && e.expanded, d = r === "collapsed" && e.expanded || r === "expanded" && !e.expanded, S = t(e.data);
      a ? (l = this.tableScope.storeStateCollapsedExpandService) == null || l.collapsedStateIdsPush(S) : d && ((n = this.tableScope.storeStateCollapsedExpandService) == null || n.collapsedStateIdsRemove(S));
    }
  }
  getArrowColumnIndex() {
...
class z {
  flattenTree(e, t = []) {
    var s;
    for (const i of e)
      this.isVisible(i) && t.push(i), (s = i.children) != null && s.length && this.flattenTree(i.children, t);
    return t;
  }
  isVisible(e) {
...
class X {
  ...
  setValue(e, t, s) {
    var n;
    const i = (n = this.columnDefs[t]) == null ? void 0 : n.editInputPipe;
    i && (s = i(s, e, t));
    const o = this.getRowByIndex(e), l = this.columnDefs[t].property;
    return l.includes(".") ? this.setPropertyValue(o, l.split("."), s) : (o[l] = s, !0);
  }
  isSelectable(e, t) {
    return !0;
  }
...
class O extends X {
  constructor(e, t, s, i = []) {
    super(e, i, s), this.areaIdent = e, this.rows = t, this.defaultRowHeight = s, this.columnDefs = i, this.sorterService = new K(), this.service = new z(), this.properties = i.map((o) => o.property), this.flattenRows = this.service.flattenTree(t), this.filteredFlattenRows = [...this.flattenRows];
  }
  changeColumnOrder(e, t) {
  ...
  setValue(e, t, s) {
    ...
    if (o) {
      const n = o.data, r = this.columnDefs[t].property;
      return r.includes(".") ? this.setPropertyValue(n, r.split("."), s) : (n[r] = s, !0);
    }
    return !1;
  }
  genericTreeTableSortComparator(e, t) {
    return (s, i) => {
      const o = this.getValueByT(s.data, e), l = this.getValueByT(i.data, e);
      return this.sorterService.genericSortComparator(o, l, t);
    };
  }
  ...
  checkAndPersistItem(e, t) {
    ...
    if (s) {
      ...
      if (i) {
        const o = i + e;
        if ((t + "").includes("Map")) {
          const l = this.autoConvertMapToObject(t);
          this.persistItem(o, l);
        } else
...
class U extends $ {
  constructor(e) {
    super(e), this.COLLAPSED_EXPANDED_STATE = "collapsedExpandedState", this.collapsedExpandedState = new q(), this.load();
  }
...
class T {
  ...
  static create(e) {
    return e.gammaRange === void 0 && (e.gammaRange = !1), new T(
      e.rowIndex1,
      e.columnIndex1,
      e.rowIndex2,
      e.columnIndex2,
  ...
  static singleRow(e) {
    return new T(e, 0, e, Number.MAX_SAFE_INTEGER);
  }
  static singleColumn(e) {
    return new T(0, e, Number.MAX_SAFE_INTEGER, e);
  }
  isInRange(e, t) {
...
class Z {
  ...
  init() {
    ...
    for (let s = 0; s < e; s++)
      for (let i = 0; i < t; i++) {
        let o = this.areaModel.getColspanAt(s, i), l = this.areaModel.getRowspanAt(s, i);
        if (o > 1 || l > 1) {
          o === 0 && (o = 1), l === 0 && (l = 1);
          const n = this.areaModel.hasOwnProperty("gammaCells");
          this.colAndRowspanRanges.push(
            new T(s, i, s + l - 1, i + o - 1, n)
          );
        }
      }
  }
...
class te extends Q {
  constructor(e, t, s, i) {
    ...
    super(e, t, s, i), this.scrollLeft = 0, this.scrollViewportLeft = 0, this.scrollFactorY = 0, this.scrollFactorX = 0, this.cleanupFunctions = {
      ...
      body: [],
      footer: []
    }, this.tree = !1, this.colAndRowspanModels = new ee(), this.firstVisibleRowIndex = -1, this.draggingTargetColumnIndex = -1, this.removables = [], this.editing = !1, this.tableModel.getSelectionModel ? this.getSelectionModel = this.tableModel.getSelectionModel : (l = this.tableOptions) != null && l.getSelectionModel && (this.getSelectionModel = this.tableOptions.getSelectionModel), (n = this.tableOptions) != null && n.getFocusModel && (this.getFocusModel = this.tableOptions.getFocusModel), t.getAreaModel("body") instanceof O && (this.tree = !0), ["header", "body", "footer"].forEach(
      (r) => {
        var a;
        this.colAndRowspanModels[r] = new Z(t, t.getAreaModel(r)), (a = this.colAndRowspanModels[r]) == null || a.init();
      }
    );
  }
  isEditing() {
  ...
  adjustAfterScrolling() {
    ...
    this.hideHoverRow(), this.hideHoverColumn(), this.scrollTop = this.scrollViewport.scrollTop, this.scrollLeft = this.scrollViewport.scrollLeft, this.debounce(this.checkForScrollPosSaving.bind(this)), this.scrollFactorY = this.scrollTop / (this.scrollViewport.scrollHeight - this.scrollViewport.clientHeight), this.scrollFactorX = this.scrollLeft / (this.scrollViewport.scrollWidth - this.scrollViewport.clientWidth), isNaN(this.scrollFactorY) && (this.scrollFactorY = 0), isNaN(this.scrollFactorX) && (this.scrollFactorX = 0), this.adjustBody(), this.adjustArea("footer"), this.adjustArea("header"), this.tableOptions.tableTopBorderVisible && this.removables.push(this.dom.addHorizontalBorder(
      ...
      new M(this.areaBodyWest.child.clientWidth, 1, this.hostElement.clientHeight, 0),
      this.hostElement,
      ...
      new M(0, this.hostElement.clientWidth, 1, this.areaHeaderCenter.child.clientHeight),
      this.hostElement,
      "ge-table-body-west-vertical-border"
    ));
  }
  ...
  adjustArea(e, t = 0) {
    var c;
    const s = this.getArea(e, "west"), i = this.getArea(e, "center"), o = this.getArea(e, "east"), l = i.child.clientHeight;
    s.child.innerText = "", i.child.innerText = "", o.child.innerText = "";
    const n = 0, r = this.areaBodyCenterGeo.width, a = this.tableModel.getPadding(), d = this.tableModel.getAreaModel(e), S = d.getRowCount();
    for (; this.cleanupFunctions[e].length; ) {
      const p = this.cleanupFunctions[e].shift();
      p && p();
    }
    let g = t;
    const f = this.tableModel.getColumnCount(), h = this.tableModel.getFixedRightColumnCount(), b = this.tableModel.getFixedLeftColumnCount();
    for (let p = 0; p < S; p++) {
      const v = g, x = p === S - 1, C = this.tableModel.getRowHeight(e, p);
      if (v + C > 0) {
        this.firstVisibleRowIndex = p;
        let w = { left: n, width: r, height: C, top: v, index: p }, m = this.dom.addRowDiv(i, w, p, e, "center");
        const R = b;
        if (this.adjustColumnsToRowParent({
          ...
          rowIndex: p,
          columnIndexStart: R,
          columnIndexEnd: f - h - 1,
          verticalFixed: !1,
          lastRowOfModel: x
        }), a.left > 0 && (w = { left: n, width: this.areaBodyWestGeo.width, height: C, top: v, index: p }, m = this.dom.addRowDiv(s, w, p, e, "west"), this.adjustColumnsToRowParent({
          areaIdent: e,
          sideIdent: "west",
          areaModel: d,
          geo: w,
          ...
          verticalFixed: !0,
          lastRowOfModel: x
        })), a.right > 0 && (w = { left: n, width: this.areaBodyEastGeo.width, height: C, top: v, index: p }, m = this.dom.addRowDiv(o, w, p, e, "east"), this.adjustColumnsToRowParent({
          areaIdent: e,
          sideIdent: "east",
          areaModel: d,
          geo: w,
          parent: m,
          rowIndex: p,
          columnIndexStart: f - h,
          columnIndexEnd: f - 1,
          verticalFixed: !0,
          lastRowOfModel: x
        })), e === "header" && this.tree && p === S - 1) {
          const E = this.dom.applyStyle(
            ...
            { cursor: "pointer" }
          ), A = this.tableOptions.treeOptions.arrowExpandCollapseAll;
          if (A) {
            const I = this.dom.domService.createText(A.content);
            this.dom.domService.appendChild(E, I), A.style && this.dom.applyStyleString(E, A.style);
          }
        }
      }
      if (g = g + C, g > l)
    ...
    if (this.colAndRowspanModels && this.colAndRowspanModels[e]) {
      const p = ((c = this.colAndRowspanModels[e]) == null ? void 0 : c.getRanges()) ?? [];
      if (p.length)
        for (const v of p) {
          let x = 0, C = i.child, w = "center";
          if (v.c1 < b)
            C = s.child, w = "west";
          else if (h > 0 && v.c1 >= f - h)
            C = o.child, w = "east";
          else {
   ...
   * @protected
   */
  drawBigCell(e, t, s, i, o, l) {
    const n = s + this.getRowHeights(0, e.r1 - 1, i).reduce((c, p) => c + p, 0), r = this.tableModel.getColumnCount(), a = this.tableModel.getFixedRightColumnCount();
    let d = 0;
    a > 0 && e.c1 >= r - a && (d = r - a);
    const S = t + this.getColumnWidths(d, e.c1 - 1).reduce((c, p) => c + p, 0), g = this.getRowHeights(e.r1, e.r2, i).reduce((c, p) => c + p, 0), f = this.getColumnWidths(e.c1, e.c2).reduce((c, p) => c + p, 0);
    let h = !1;
    const b = this.getSelectionModel ? this.getSelectionModel() : void 0;
    b && (h = b.getSelectionCount(e.r1, e.c1) > 0), e.gammaRange ? (console.info("TODO here", e), this.renderCell({
      areaModel: i,
  ...
  adjustColumnsToRowParent({
    ...
    let h = S;
    for (let c = n; c <= r; c++) {
      const p = h, v = this.tableModel.getColumnWidth(c);
      if (v > 0 && p + v > 0) {
        let x = i.height;
        const C = s.getRowspanAt(l, c), w = s.getColspanAt(l, c);
        C > 1 && (x = this.getRowHeights(l, l + C - 1, s).reduce((E, A) => E + A, 0));
        let m = v;
        w > 1 && (m = this.getColumnWidths(c, c + w - 1).reduce((E, A) => E + A, 0));
        let R = !1;
        if (this.colAndRowspanModels && this.colAndRowspanModels[e] && (b = this.colAndRowspanModels[e]) != null && b.isInRange(l, c) && (R = !0), this.draggingTargetColumnIndex === c && e !== "header") {
          this.renderDragTargetDiv(o, p, g, m, x);
          const E = { left: p, top: g, width: m, height: x };
          this.dom.addColumnBorderDivs(this.tableOptions, o, E, e, t);
        } else {
          const E = this.renderSelectedBackgroundDiv(R, f, t, s, l, c, o, p, g, m, x);
          R || this.renderCell({
            areaModel: s,
            areaIdent: e,
            sideIdent: t,
      ...
      if (h = h + v, h > this.areaBodyCenterGeo.width)
        break;
    }
    this.tableOptions.verticalBorderVisible && this.dom.addVerticalBorder(new M(h - 1, 1, i.height, 0), o);
  }
  ...
  addAndRenderCellDiv({
    ...
    var k;
    const f = this.editorRenderer && this.editorRendererRow === i && this.editorRendererColumn === o ? this.editorRenderer : e.getCellRenderer(i, o), h = { left: l, width: n, height: r, top: a, index: o }, b = e.getRowByIndex(i);
    let c = "none";
    if (o === this.getTreeArrowColumnIndex() && b instanceof L) {
      const y = b;
      (k = y.children) != null && k.length ? y.expanded ? c = "expanded" : c = "collapsed" : c = "hidden";
    }
    let v;
    if (t === "header") {
    ...
    const x = e.getValueAt(i, o), C = f ? "" : `${x}`, w = e.isRowChecked(i), m = this.dom.addColumnDiv(
      d,
      h,
      i,
      o,
      ...
      w,
      v
    ), R = e.getTooltipAt(i, o);
    R && this.dom.setAttribute(m, "title", R);
    const E = this.tableModel.getColumnDef(o);
    E && E.classes[t] && this.dom.addClasses(E.classes[t], m);
    let A;
    f && (A = f.render(m, i, o, t, e, x, this.dom.domService));
    const I = e.getCustomClassesAt(i, o);
    if (I.length && this.dom.addClasses(I, m), this.dom.addColumnBorderDivs(this.tableOptions, d, h, t, s), S && this.dom.addHorizontalBorder({ left: l, width: n, height: r, top: a + r }, d), this.getFocusModel && t === "body") {
      const y = this.getFocusModel();
      y != null && y.hasFocus(i, o) && this.dom.addFocusBorderDivs(d, h, {});
    }
    t === "header" && this.dom.setAttribute(m, "data-ge-action", "drag-column");
    const F = e.getCustomStyleAt(i, o);
    if (F)
      for (const y in F)
        this.dom.setStyle(m, y, F[y]);
    return [m, A];
  }
  getColumnWidths(e, t) {
    const s = [];
  ...
  renderDragTargetDiv(e, t, s, i, o) {
    const l = this.dom.applyStylePosistionAbsolute(
      this.dom.createDivWithClass("ge-table-drop-zone", e)
    );
    return this.dom.setStyle(l, "left", `${t}px`), this.dom.setStyle(l, "top", `${s}px`), this.dom.setStyle(l, "width", `${i}px`), this.dom.setStyle(l, "height", `${o}px`), l;
  }
  renderSelectedBackgroundDiv(e, t, s, i, o, l, n, r, a, d, S) {
    let g = !1;
    if (!e && t && i.isSelectable(o, l) && this.getSelectionModel) {
      const f = this.getSelectionModel();
      if (f) {
        const h = f.getSelectionCount(o, l);
        g = h > 0;
        for (let b = 0; b < h; b++) {
          ...
          this.dom.setStyle(c, "left", `${r}px`), this.dom.setStyle(c, "top", `${a}px`), this.dom.setStyle(c, "width", `${d}px`), this.dom.setStyle(c, "height", `${S}px`);
        }
      }
    }
    return g;
  ...
  renderCell({
    ...
    const [h, b] = this.addAndRenderCellDiv({
      areaModel: e,
      areaIdent: t,
      sideIdent: s,
      rowIndex: i,
    ...
    S && this.dom.addClass(`ge-table-${t}-${s}-selected-range`, h), b && this.cleanupFunctions[t].push(b);
  }
  renderHeaderCellResizeHandle({ rowIndex: e, columnIndex: t, cellLeft: s, cellTop: i, cellWidth: o, cellHeight: l, parent: n }) {
    const r = this.dom.domService, a = this.tableOptions.columnResizeHandleWidthInPx ?? 2, d = r.createElement("div");
    r.setAttribute(d, "data-col-index", `${t}`), r.setAttribute(d, "data-row-index", `${e}`), r.setAttribute(d, "data-area", "header"), r.setAttribute(d, "data-ge-action", "resize-column"), r.addClass(d, "ge-table-column-resize-handle"), r.setStyle(d, "display", "clip"), r.setStyle(d, "position", "absolute"), r.setStyle(d, "cursor", "col-resize"), r.setStyle(d, "left", `${s + o - a}px`), r.setStyle(d, "top", `${i}px`), r.setStyle(d, "width", `${a}px`), r.setStyle(d, "height", `${l}px`), r.appendChild(n, d);
  }
}
class se {
  constructor(e, t) {
...
class ie {
  ...
  onHostElementChanged(e) {
    if (e.target instanceof HTMLInputElement || e.target instanceof HTMLSelectElement || e.target instanceof HTMLTextAreaElement) {
      ...
      if (s && i && o) {
        const l = P(s), n = Number(i), r = Number(o);
        this.tableScope.updateModelValueAfterEdit(l, n, r, t.value);
      }
    }
  }
}
...
class re {
  ...
  onMouseClicked(e, t) {
    ...
    if (this.getSelectionModel && this.getFocusModel) {
      ...
      g && f && (f.hasFocus(e.rowIndex, e.columnIndex) || (f.setFocus(e.rowIndex, e.columnIndex), s = !0), (o = e.originalEvent) != null && o.shiftKey || g.hasSelection() && (g.clear(), s = !0), (l = e.originalEvent) != null && l.shiftKey && this.previousEvt ? (g.addSelection(this.createRangeByEvents(e, this.previousEvt)), i = !0, s = !0) : (n = e.originalEvent) != null && n.ctrlKey || (r = e.originalEvent) != null && r.metaKey ? (g.addSelection(T.singleCell(e.rowIndex, e.columnIndex)), i = !0, s = !0) : (a = e.originalEvent) != null && a.altKey && ((d = e.originalEvent) != null && d.ctrlKey || (S = e.originalEvent) != null && S.metaKey) && (g.removeSelection(T.singleCell(e.rowIndex, e.columnIndex)), i = !0, s = !0));
    }
  ...
  createRangeByEvents(e, t) {
    t || (t = e);
    const s = Math.min(e.rowIndex, t == null ? void 0 : t.rowIndex), i = Math.max(e.rowIndex, t == null ? void 0 : t.rowIndex), o = Math.min(e.columnIndex, t == null ? void 0 : t.columnIndex), l = Math.max(e.columnIndex, t == null ? void 0 : t.columnIndex);
    return T.create({
      rowIndex1: s,
      columnIndex1: o,
      rowIndex2: i,
...
class he extends te {
  constructor(e, t, s, i, o) {
    ...
    if (super(
      ...
      new _(s),
      i
    ), this.eventListener = o, this.selectionService = new re(this), this.api = new j(this), this.mouseStartAction = "", this.mouseStartWidth = -1, this.mouseStartColumnIndex = -1, this.dragFrom = -1, this.dragTo = -1, o || (this.eventListener = new de()), (l = this.tableOptions) != null && l.autoRestoreOptions) {
      const n = this.tableOptions.autoRestoreOptions, r = n.getStorageKeyFn;
      r && (n.autoRestoreScrollPosition && (this.storeScrollPosStateService = new Y(r)), n.autoRestoreCollapsedExpandedState && (this.storeStateCollapsedExpandService = new U(r)), n.autoRestoreSortingState && (this.storeSortingService = new J(r)));
    }
    this.mouseHandler = new N(this), this.inputHandler = new ie(this), this.shortcutService = new ae(this), this.shortcutService.addListener(this.selectionService);
  }
  onActionTriggered(e) {
  ...
  updateModelValueAfterEdit(e, t, s, i) {
    e === "body" && this.tableModel.getAreaModel(e).setValue(t, s, i) && (this.resetEditorRenderer(), this.repaint(), this.eventListener.onModelChanged(H.createSingle(t, s)), this.hostElement.focus());
  }
  getApi() {
    return this.api;
  }
  ...
  toggleExpandCollapseAll(e = !0) {
    ...
    t instanceof O && (t.toggleExpandCollapseAll(e), this.repaint(), (s = this.storeStateCollapsedExpandService) == null || s.collapsedStateAll(e));
  }
  toggleRowCheckbox(e, t, s) {
    var r;
    const i = this.tableModel.getAreaModel(s), o = i.isRowChecked(e), l = o === void 0 || o === "semi" || o === "none";
    i.setRowChecked(e, l), this.repaint();
    const n = (r = i.rowSelectionModel) == null ? void 0 : r.getCheckedRows();
  ...
  onHeaderDblClicked(e, t, s) {
    ...
    if (i != null && i.sortable && i.sortable()) {
      e.preventDefault(), e.stopPropagation();
      const n = i.sortStatesOrder ? i.sortStatesOrder : this.tableOptions.sortOrder, r = i.sortState ?? "", a = n[(n.indexOf(r) + 1) % n.length], d = new se(s, a);
      this.tableModel.doSort([d]) && ((o = this.tableModel.getColumnDefs()) == null || o.forEach((g) => g.sortState = ""), i.sortState = a), this.repaint(), (l = this.storeSortingService) == null || l.setSortItems([d]);
    }
  }
  changeFocusCell(e, t) {
  ...
  autoRestoreCollapsedExpandedState() {
    ...
    if ((t = (e = this.tableOptions) == null ? void 0 : e.autoRestoreOptions) != null && t.getRowId && this.storeStateCollapsedExpandService) {
      ...
      if (s.autoRestoreCollapsedExpandedState && i) {
        const o = this.storeStateCollapsedExpandService.collapsedExpandedStateGet(), l = this.tableModel.getAreaModel("body");
        if (l instanceof O) {
          const n = l, r = l.getRowCount();
          for (let a = 0; a < r; a++) {
            const d = l.getRowByIndex(a);
            if (d)
              if (o.allExpanded)
                d.expanded = !0;
...
class pe extends HTMLElement {
  ...
  set data(e) {
    this._data = e, e && this.setData(e);
  }
  setData({ tableModel: e, tableOptions: t }) {
    this.innerHTML = `
     <div
      class="container-div"
      style="width: 100%; height: 100%; background-color: transparent; padding: 0; margin: 0; display: block"></div>
    `;
    const s = this.querySelector("div"), i = new ce();
    if (e) {
      const o = {
        onCheckboxChanged: (r) => {
          const a = new CustomEvent("checkboxChanged", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onContextmenu: (r) => {
          const a = new CustomEvent("contextmenu", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onModelChanged: (r) => {
          const a = new CustomEvent("modelChanged", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onMouseClicked: (r) => {
          const a = new CustomEvent("mouseClicked", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onMouseDragging: (r) => {
          const a = new CustomEvent("mouseDragging", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onMouseDraggingEnd: (r) => {
          const a = new CustomEvent("mouseDraggingEnd", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        },
        onMouseMoved: (r) => {
          const a = new CustomEvent("mouseMoved", { detail: r, bubbles: !0 });
          s.dispatchEvent(a);
        }
      }, l = new he(
        s,
      ...
      i.setStyle(s, "height", "100%"), i.setStyle(s, "width", "100%"), l.firstInit();
      const n = new CustomEvent("tableReady", { detail: l.getApi(), bubbles: !0 });
      s.dispatchEvent(n), console.info(s);
    }
  }
  connectedCallback() {
