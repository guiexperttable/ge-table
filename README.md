...
- [Plain JS](https://github.com/guiexperttable/ge-table/tree/main/packages/table)
- [Vue3](https://github.com/guiexperttable/ge-table/tree/main/packages/vue3-table)
...
| Angular 21.x.x | @guiexpert/angular-table@^21.0.0     | @guiexpert/table@latest  |
...
This mono repository leverages the package-based approach and utilizes [pnPM](https://pnpm.io/).
